...
describe('echte Mehrgrößen- und Profilregression', () => {
  ...
  it('schreibt exakt 526 Mehrgrößen-Snapshots', () => {
    ...
    expect(snapshots).toHaveLength(526);
    expect(names).toContain('recipe.C.1.3.svg');
    expect(names).toContain('recipe.G.1.svg');
    expect(names).toContain('recipe.G.8.svg');
    expect(names).toContain('recipe.I.1.1.svg');
    expect(names).toContain('recipe.I.1.2.svg');
    expect(names).toContain('recipe.I.1.3.svg');
    expect(names).toContain('recipe.I.1.4.svg');
    ...
    expect(names).toContain('recipe.I.1.13.svg');
    expect(names).toContain('recipe.I.1.14.svg');
    expect(names).toContain('recipe.I.1.15.svg');
    expect(names).toContain('recipe.I.1.16.svg');
    ...
    expect(names).toContain('recipe.I.2.4.svg');
    expect(names).toContain('recipe.I.2.5.svg');
    expect(names).toContain('recipe.I.2.6.svg');
    expect(names).toContain('recipe.I.2.7.svg');
