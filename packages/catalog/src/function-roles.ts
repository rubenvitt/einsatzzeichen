...
function formationRole(
  ...
  return {
    ...
    ...(expectedStrength === undefined ? {} : { expectedStrength }),
    allowedBodyMarks: [],
    layout: {
...
interface PersonRoleOptions {
  ...
  expectedStrength?: StrengthId;
  expectedAdministrativeLevel?: AdminLevelId;
...
function personRole(options: PersonRoleOptions): FunctionRoleDefinition {
  ...
  return {
    ...
    kind: 'person',
    expectedHead,
    expectedOrganization: options.expectedOrganization,
    ...(options.expectedStrength === undefined
      ? {}
      : { expectedStrength: options.expectedStrength }),
    ...(options.expectedAdministrativeLevel === undefined
      ? {}
      : { expectedAdministrativeLevel: options.expectedAdministrativeLevel }),
...
const DEFINITIONS: Record<FunctionRoleId, FunctionRoleDefinition> = {
  ...
  'medical-platoon-commander': personRole({
    ...
    expectedOrganization: 'hilfsorganisation',
    organizationHead: 'strength', bodyCenterYMm: 18, capShoulderYMm: 10,
    expectedStrength: 'zug',
  ...
  'international-relief-operation-director': personRole({
    ...
    expectedAdministrativeLevel: 'europaeische-union',
    capShoulderYMm: 14,
  }),
};
