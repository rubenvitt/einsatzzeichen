...
describe('SVG-Snapshots', () => {
  it('schreibt exakt 256 direkte SVG-Snapshots', () => {
    ...
    expect(names).toContain('I.1.1.svg');
    expect(names).toContain('I.1.2.svg');
    expect(names).toContain('I.1.3.svg');
    expect(names).toContain('I.1.4.svg');
    ...
    expect(names).toContain('I.1.13.svg');
    expect(names).toContain('I.1.14.svg');
    expect(names).toContain('I.1.15.svg');
    expect(names).toContain('I.1.16.svg');
    ...
    expect(names).toContain('I.2.4.svg');
    expect(names).toContain('I.2.5.svg');
    expect(names).toContain('I.2.6.svg');
    expect(names).toContain('I.2.7.svg');
