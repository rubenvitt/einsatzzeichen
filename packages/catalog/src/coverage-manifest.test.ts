...
describe('Coverage-Manifest', () => {
  ...
  it('enthält exakt 205 Zeilen mit 194 Elementdarstellungen', () => {
    ...
    expect(COVERAGE_MANIFEST.entries).toHaveLength(205);
    expect(elementRows).toHaveLength(194);
    expect(pictogramRows).toHaveLength(183);
