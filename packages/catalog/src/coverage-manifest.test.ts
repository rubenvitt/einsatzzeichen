...
describe('Coverage-Manifest', () => {
  ...
  it('enthält exakt 440 Zeilen mit 273 Elementdarstellungen', () => {
    ...
    expect(counts).toEqual({
      ...
      // die drei vermessenen Wasserfahrzeuge I.3.5 bis I.3.7; C.1.3 ergänzt ein Rezept und
      // Anhang N neun primary-Darstellungen weiterer Träger.
      'composition-recipe': 153,
    ...
    expect(COVERAGE_MANIFEST.entries).toHaveLength(440);
