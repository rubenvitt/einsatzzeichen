...
describe('Coverage-Manifest', () => {
  ...
  it('enthält exakt 525 Zeilen mit 288 Elementdarstellungen', () => {
    ...
    expect(COVERAGE_MANIFEST.entries).toHaveLength(525);
