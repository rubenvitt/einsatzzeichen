...
describe('vollständige Renderfallmenge', () => {
  ...
  it('ist nicht leer und über die Implementierungs-ID eindeutig', () => {
    ...
    // 408 seit I-a: 308 nach LFH-424, plus die 31 Zeichen aus E.2, alle 66 F-Rezepte und drei
    // gemessene Wasserfahrzeuge aus Anhang I.
    ...
    // dazu 21 aus E-d, fünf aus E-e und fünf aus E-f. Anhang F ergänzt 66 weitere, I-a drei.
