...
describe('vollständige Renderfallmenge', () => {
  ...
  it('ist nicht leer und über die Implementierungs-ID eindeutig', () => {
    ...
    // 421 seit LFH-422: 412 nach C.1.3, H und I-a plus die neun primary-Rezepte aus Anhang N.
    expect(ids).toHaveLength(421);
    ...
    expect(ids.filter((id) => id.startsWith('recipe.'))).toHaveLength(153);
