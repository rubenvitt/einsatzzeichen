...
describe('vollständige Renderfallmenge', () => {
  ...
  it('ist nicht leer und über die Implementierungs-ID eindeutig', () => {
    ...
    // 488: der integrierte Hauptbestand plus die LFH-485-, LFH-486- und LFH-488-Rezeptfälle.
    expect(ids).toHaveLength(488);
    ...
    // I-a/I-b/I-j jeweils drei, I-g vier, C.1.3 einen, Anhang N neun und Anhang D 26 Fälle.
    expect(ids.filter((id) => id.startsWith('recipe.'))).toHaveLength(210);
