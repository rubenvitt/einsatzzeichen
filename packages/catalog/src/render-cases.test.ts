...
describe('vollständige Renderfallmenge', () => {
  ...
  it('ist nicht leer und über die Implementierungs-ID eindeutig', () => {
    ...
    // 483: der integrierte Hauptbestand plus fünf neue Anhang-I-e-Renderfälle.
    expect(ids).toHaveLength(483);
    ...
    expect(ids.filter((id) => id.startsWith('recipe.'))).toHaveLength(205);
