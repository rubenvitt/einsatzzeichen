...
/** Alle Piktogramme des Katalogs, ein Modul je fachlich getrenntem ID-Bereich. */
...
export { WATER_RESCUE_PERSONNEL_PICTOGRAMS } from './water-rescue-personnel/index.js';
