...
export const CAPABILITY_BLOCKS: readonly BlockEntry[] = Object.freeze([
  capability(
    'cbrn-protection',
    'core/src/geometry/pictograms/capabilities/01-cbrn.ts:146–153',
    '4.1.1',
    'ABC-/CBRN-Schutz',
  ...
  capability(
    'cbrn-detection',
    'core/src/geometry/pictograms/capabilities/01-cbrn.ts:154–162',
    '4.1.2',
  ...
  capability(
    'decontamination',
    'core/src/geometry/pictograms/capabilities/01-cbrn.ts:163–177',
    '4.1.3',
    'Dekontaminieren',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/01-cbrn.ts:178–199',
    '4.1.4',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/01-cbrn.ts:200–226',
    '4.1.5',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/01-cbrn.ts:227–241',
    '4.1.6',
    'Atomare Stoffe',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/01-cbrn.ts:251–264',
    '4.1.7',
    'Biologische Stoffe',
  ...
  capability(
    'chemical-materials',
    'core/src/geometry/pictograms/capabilities/01-cbrn.ts:274–287',
    '4.1.8',
    'Chemische Stoffe',
  ...
  capability(
    'care',
    'core/src/geometry/pictograms/capabilities/02-care.ts:28–35',
    '4.2.1',
    'Betreuung',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/02-care.ts:36–62',
    '4.2.2',
    'PSNV',
    '4.2.2_PSNV.svg',
  ),
  capability(
    'pastoral-care',
    'core/src/geometry/pictograms/capabilities/02-care.ts:63–77',
    '4.2.3',
    'Seelsorge',
    '4.2.3_Seelsorge.svg',
  ),
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/02-care.ts:78–97',
    '4.2.4',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/02-care.ts:98–107',
    '4.2.5',
  ...
  capability(
    'fire-fighting',
    'core/src/geometry/pictograms/capabilities/03-fire-fighting.ts:23–32',
    '4.3.1',
    'Brandbekämpfung',
  ...
  capability(
    'service-water',
    'core/src/geometry/pictograms/capabilities/03-fire-fighting.ts:33–54',
    '4.3.2',
  ...
  capability(
    'foam-agent',
    'core/src/geometry/pictograms/capabilities/03-fire-fighting.ts:55–71',
    '4.3.3',
    'Schaummittel',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/03-fire-fighting.ts:72–82',
    '4.3.4',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/03-fire-fighting.ts:83–91',
    '4.3.5',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/03-fire-fighting.ts:92–113',
    '4.3.6',
    'Atemschutz',
  ...
  capability(
    'reconnaissance',
    'core/src/geometry/pictograms/capabilities/04-reconnaissance.ts:23–24',
    '4.4.1',
    'Erkunden',
    '4.4.1_Erkunden.svg',
  ),
  capability(
    'biological-location',
    'core/src/geometry/pictograms/capabilities/04-reconnaissance.ts:25–44',
    '4.4.2',
    'Orten, biologisch',
  ...
  capability(
    'technical-location',
    'core/src/geometry/pictograms/capabilities/04-reconnaissance.ts:45–66',
    '4.4.3',
    'Orten, technisch',
  ...
  capability(
    'recovery',
    'core/src/geometry/pictograms/capabilities/05-rescue.ts:89–98',
    '4.5.1',
    'Bergung',
    '4.5.1_Bergung.svg',
  ),
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/05-rescue.ts:99–113',
    '4.5.2',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/05-rescue.ts:114–122',
    '4.5.3',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/05-rescue.ts:123–132',
    '4.5.4',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/05-rescue.ts:133–149',
    '4.5.5',
  ...
  capability(
    'mountain-rescue',
    'core/src/geometry/pictograms/capabilities/05-rescue.ts:150–168',
    '4.5.6',
    'Bergrettung',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/05-rescue.ts:169–184',
    '4.5.7',
  ...
  capability(
    'water-rescue',
    'core/src/geometry/pictograms/capabilities/05-rescue.ts:185–194',
    '4.5.8',
    'Wasserrettung',
  ...
  capability(
    'medical-service',
    'core/src/geometry/pictograms/capabilities/06-medical.ts:25–32',
    '4.6.1',
  ...
  capability(
    'nursing',
    'core/src/geometry/pictograms/capabilities/06-medical.ts:33–41',
    '4.6.2',
    'Pflege',
    '4.6.2_Pflege.svg',
  ),
  capability(
    'intensive-care',
    'core/src/geometry/pictograms/capabilities/06-medical.ts:42–50',
    '4.6.3',
  ...
  capability(
    'physician',
    'core/src/geometry/pictograms/capabilities/06-medical.ts:51–59',
    '4.6.4',
    'Arztwesen',
    '4.6.4_Arztwesen.svg',
  ),
  capability(
    'patient-transport',
    'core/src/geometry/pictograms/capabilities/06-medical.ts:60–74',
    '4.6.5',
    'Patiententransport',
  ...
  capability(
    'hospital',
    'core/src/geometry/pictograms/capabilities/06-medical.ts:75–98',
    '4.6.6',
    'Krankenhaus',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:133–145',
    '4.7.1',
  ...
  capability(
    'excavation',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:146–157',
    '4.7.2',
    'Baggerarbeiten',
  ...
  capability(
    'lighting',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:158–169',
    '4.7.3',
    'Beleuchten',
  ...
  capability(
    'ventilation',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:170–186',
    '4.7.4',
    'Belüften',
    '4.7.4_Belüften.svg',
  ),
  capability(
    'air-extraction',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:187–204',
    '4.7.5',
    'Entlüften',
    '4.7.5_Entlüften.svg',
  ),
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:205–219',
    '4.7.6',
    'Kampfmittelräumung',
  ...
  capability(
    'hand-tools',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:220–241',
    '4.7.7',
  ...
  capability(
    'forklift-lifting',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:242–253',
    '4.7.8',
  ...
  capability(
    'crane-lifting',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:254–262',
    '4.7.9',
    'Hebearbeit mit Kran',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:263–275',
    '4.7.10',
  ...
  capability(
    'lifting-clearing',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:290–301',
    '4.7.11',
    'Heben / Räumen',
  ...
  capability(
    'remote-manipulation',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:302–314',
    '4.7.12',
    'Fernmanipulieren',
  ...
  capability(
    'chainsaw',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:315–328',
    '4.7.13',
    'Motorsägearbeiten',
  ...
  capability(
    'pumping',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:329–340',
    '4.7.14',
    'Pumpen',
    '4.7.14_Pumpen.svg',
  ),
  capability(
    'mechanized-clearing',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:341–352',
    '4.7.15',
  ...
  capability(
    'safety',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:353–367',
    '4.7.16',
    'Sicherheit',
  ...
  capability(
    'blasting',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:368–379',
    '4.7.17',
    'Sprengen',
    '4.7.17_Sprengen.svg',
  ),
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:380–395',
    '4.7.18',
  ...
  capability(
    'transport',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:396–414',
    '4.7.19',
    'Transportieren',
  ...
  capability(
    'door-opening',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:415–427',
    '4.7.20',
    'Türöffnung',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:428–441',
    '4.7.21',
  ...
  capability(
    'securing',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:442–456',
    '4.7.22',
    'Absicherung',
  ...
  capability(
    'optical-warning',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:457–472',
    '4.7.23',
  ...
  capability(
    'loudspeaker-warning',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:473–489',
    '4.7.24',
  ...
  capability(
    'siren-warning',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:490–502',
    '4.7.25',
    'Warnen mit Sirenen',
  ...
  capability(
    'water-conveyance',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:503–517',
    '4.7.26',
    'Wasserförderung',
  ...
  capability(
    'water-retention',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:518–530',
    '4.7.27',
    'Wasserrückhaltung',
  ...
  capability(
    'load-pulling',
    'core/src/geometry/pictograms/capabilities/07-technical-assistance.ts:531–543',
    '4.7.28',
    'Ziehen von Lasten',
  ...
  capability(
    'container-resource',
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:85–93',
    '4.8.1',
    'Behälter',
    '4.8.1_Behälter.svg',
  ),
  capability(
    'fuels-consumables',
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:94–108',
    '4.8.2',
  ...
  capability(
    'bridge',
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:109–121',
    '4.8.3',
    'Brücke',
    '4.8.3_Brücke.svg',
  ),
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:122–138',
    '4.8.4',
    'Behelfsbrückenbau',
  ...
  capability(
    'waste-disposal',
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:139–155',
    '4.8.5',
    'Entsorgung',
  ...
  capability(
    'maintenance',
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:156–169',
    '4.8.6',
    'Instandhaltung',
  ...
  capability(
    'sandbag',
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:170–189',
    '4.8.7',
    'Sandsack',
    '4.8.7_Sandsack.svg',
  ),
  capability(
    'sandbag-filling',
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:190–204',
    '4.8.8',
    'Sandsackbefüllung',
  ...
  capability(
    'washing-facility',
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:205–220',
    '4.8.9',
  ...
  capability(
    'toilet-facility',
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:221–237',
    '4.8.10',
  ...
  capability(
    'power-supply',
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:238–250',
    '4.8.11',
    'Stromversorgung',
  ...
  capability(
    'drinking-water',
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:251–264',
    '4.8.12',
    'Trinkwasser',
  ...
  capability(
    'catering',
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:265–273',
    '4.8.13',
    'Verpflegung',
  ...
  capability(
    'meal-preparation',
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:274–294',
    '4.8.14',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:295–304',
    '4.8.15',
    'Schnelleinsatzzelt',
  ...
  capability(
    'frame-tent',
    'core/src/geometry/pictograms/capabilities/08-logistics.ts:305–319',
    '4.8.16',
    'Stangengerüstzelt',
  ...
  capability(
    ...
    'core/src/geometry/pictograms/capabilities/09-information-communications.ts:6–21',
    '4.9.1',
  ...
  capability(
    'veterinary',
    'core/src/geometry/pictograms/capabilities/10-veterinary.ts:132–140',
    '4.10.1',
    'Veterinärwesen',
  ...
  capability(
    'slaughter-culling',
    'core/src/geometry/pictograms/capabilities/10-veterinary.ts:141–150',
    '4.10.2',
    'Schlachten / Keulen',
  ...
  capability(
    'chicken',
    'core/src/geometry/pictograms/capabilities/10-veterinary.ts:151–166',
    '4.10.3',
    'Huhn',
    '4.10.3_Huhn.svg',
  ),
  capability(
    'horse',
    'core/src/geometry/pictograms/capabilities/10-veterinary.ts:167–184',
    '4.10.4',
    'Pferd',
    '4.10.4_Pferd.svg',
  ),
  capability(
    'cattle',
    'core/src/geometry/pictograms/capabilities/10-veterinary.ts:185–200',
    '4.10.5',
    'Rind',
    '4.10.5_Rind.svg',
  ),
  capability(
    'sheep',
    'core/src/geometry/pictograms/capabilities/10-veterinary.ts:201–220',
    '4.10.6',
    'Schaf',
    '4.10.6_Schaf.svg',
  ),
  capability(
    'pig',
    'core/src/geometry/pictograms/capabilities/10-veterinary.ts:221–235',
    '4.10.7',
    'Schwein',
    '4.10.7_Schwein.svg',
  ),
...
const FUNCTION_ROLES_FILE = 'core/src/geometry/function-roles.ts';
