...
describe('coverage CLI', () => {
  it('weist alle Reviewträger getrennt aus und meldet null technische Nachweislücken', () => {
    ...
    // I.2.4 bis I.2.7 ergänzen vier Anhänger auf 501 Zeilen.
    ...
    expect(lines).toContain(
      'Umfang:      1, 2, 4, 5.1.1, 5.4, 5.8, C.1.1, C.1.2, C.1.3, D, E, F, G, H, I.2.4, I.2.5, I.2.6, I.2.7, I.3.5, I.3.6, I.3.7, J.1, J.2, J.3, J.4, K, L, M, N',
    );
