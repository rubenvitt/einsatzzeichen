...
describe('coverage CLI', () => {
  it('weist alle Reviewträger getrennt aus und meldet null technische Nachweislücken', () => {
    ...
    // I-d, I-g und I-b ergänzen je vier, I-j drei und I.5 fünf Wasserrettungszeilen: insgesamt 517.
    expect(manifestReviews).toBe(517);
    expect(sourceReviews).toBe(13);
    expect(profileReviews).toBe(1);
    expect(openReviews).toBe(531);
    ...
    // `E` eine widerlegbare Aussage statt einer kürzeren. I-d, I-g und I-b bleiben dagegen
    // jeweils auf ihren vier gebauten Einzelabschnitten statt pauschal auf `I.1` oder `I` begrenzt.
    expect(lines).toContain(
      'Umfang:      1, 2, 4, 5.1.1, 5.4, 5.8, C.1.1, C.1.2, C.1.3, D, E, F, G, H, I.1.5, I.1.6, I.1.7, I.1.8, I.1.17, I.1.18, I.1.19, I.1.20, I.2.4, I.2.5, I.2.6, I.2.7, I.3.5, I.3.6, I.3.7, I.4.1, I.4.2, I.4.3, I.5.4, I.5.5, I.5.6, I.5.7, I.5.8, J.1, J.2, J.3, J.4, K, L, M, N',
    );
