...
describe('coverage CLI', () => {
  it('weist alle Reviewträger getrennt aus und meldet null technische Nachweislücken', () => {
    ...
    // I-j ergänzt drei Orte, I-c und I-g ergänzen je vier Formationen: insgesamt 508.
    expect(manifestReviews).toBe(508);
    expect(sourceReviews).toBe(13);
    expect(profileReviews).toBe(1);
    expect(openReviews).toBe(522);
    ...
    expect(lines).toContain(
      'Umfang:      1, 2, 4, 5.1.1, 5.4, 5.8, C.1.1, C.1.2, C.1.3, D, E, F, G, H, I.1.1, I.1.2, I.1.3, I.1.4, I.1.17, I.1.18, I.1.19, I.1.20, I.3.5, I.3.6, I.3.7, I.4.1, I.4.2, I.4.3, J.1, J.2, J.3, J.4, K, L, M, N',
    );
